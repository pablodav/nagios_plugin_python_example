...
mypackage_root_dir = 'examplepackage'
...
setup(name='example1',
      version=version,
      description='example1 monitor nagios plugin',
      ...
      url='https://github.com/example1/example1',
      author='Author Name',
      author_email='email',
      ...
      entry_points={
          'console_scripts': [
              ...
              'examplecommand1 = examplepackage.__main__:main'
          ]
      },
